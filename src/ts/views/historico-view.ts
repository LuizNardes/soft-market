...
export class HistoricoView extends View<ListaDeProdutosHistorico> {
  protected template(model: ListaDeProdutosHistorico): string {
  ...
  private TotalCompra(lista:ListaDeProdutosHistorico,CodigoPedido:string) :string
  { 
  ...
  private TotalImpostos(lista:ListaDeProdutosHistorico,CodigoPedido:string) :string
  { 
